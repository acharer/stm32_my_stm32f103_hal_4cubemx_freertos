...
#define AP_INT_GPIO_PORT                GPIOF
#define AP_INT_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOF_CLK_ENABLE()
#define AP_INT_GPIO_PIN                 GPIO_PIN_8

/*******************************************************/

#define AP_INT_Read()    HAL_GPIO_ReadPin(AP_INT_GPIO_PORT, AP_INT_GPIO_PIN)    // 读中断引脚的状态
